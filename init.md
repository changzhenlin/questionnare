...
1. **生成产品需求文档（PRD）或应用设计文档**    
   - **提示示例**（在新会话中输入）：  
     “请帮我生成一份完整的 Markdown 格式产品需求文档（PRD）。应用名称：[您的应用名称]，一句话核心目标：[例如：一个帮助用户记录每日习惯的移动端 Web 应用]。请包含：用户画像、核心功能列表、功能优先级、非功能需求（性能、安全等）、成功指标、潜在风险。输出为 `prd.md` 格式。”  
